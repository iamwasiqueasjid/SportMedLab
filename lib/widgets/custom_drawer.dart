  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> drawerItems = [
      ...
      ListTile(
        ...
        selected:
        currentRoute == '/doctorDashboard' || currentRoute == '/patientDashboard',
      ...
      if (role == 'Patient' || role == 'Doctor') ...[
        ListTile(
          ...
          title: Text('Patient Blog Screen', style: TextStyle(color: theme.primaryColor)),
          selected: currentRoute == '/patients',
          selectedTileColor: theme.primaryColor,
          onTap: () {
            Navigator.pop(context);
            Navigator.pushReplacementNamed(context, '/patientsBlog'); // Changed to /patients
          },
        ),
      ],
